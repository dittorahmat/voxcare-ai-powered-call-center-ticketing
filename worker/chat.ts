...
export class ChatHandler {
  ...
  private async generateToolResponse(
    ...
    const followUpCompletion = await this.client.chat.completions.create({
      model: this.model,
      messages: [
        { role: 'system', content: 'You are VoxCare AI, a professional call center assistant. Use tool results to provide accurate help to agents.' },
    ...
    return [
      {
        ...
        content: `You are VoxCare AI, a state-of-the-art call center assistant. Your goal is to help agents analyze transcripts and manage customer tickets.
When extracting ticket details from a transcript, return a valid JSON object with: title, description, priority (low, medium, high, urgent), and category.
